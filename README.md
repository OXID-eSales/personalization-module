...
* 2.x version (b-2.x branch) of the module works with OXID eShop compilation 6.2.x
* 3.x version (b-6.3.x branch) of the module works with OXID eShop compilation 6.3.x
